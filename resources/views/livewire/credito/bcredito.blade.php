                                    ...
                                    @if ($aux)
                                        <tr class="">
                                            ...
                                            <td class="px-5 py-3 border border-gray-200 bg-white ">
                                                <p class="text-black whitespace-no-wrap">{{ $credito->Venta->Folio }}
                                                </p>
                                            </td>
                                            <td class="px-5 py-3 border border-gray-200 bg-white ">
                                            ...
                                            <td class="px-5 py-3 border border-gray-200 bg-white ">
                                                @if ($credito->Venta->Cliente->TipoP == 'Moral')
                                                    <p>{{ $credito->Venta->Cliente->NomCom }}</p>
                                                @else
                                                    <p>{{ $credito->Venta->Cliente->Nombre }}
                                                        {{ $cliente->Venta->Cliente->ApP }}
                                                        {{ $credito->Venta->Cliente->ApM }}</p>
                                                @endif
                                            </td>
                                        </tr>
                                        <var {{ $aux = false }} />
